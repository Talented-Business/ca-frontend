				...
				items:[
					...
					},
					{
						...
						submenu: [
							{
								title: 'Members List',
								page: '/employee-management/employees'
							},
							{
								title: 'Recruitment',
								page: '/employee-management/recruits'
							}
						]
					},	
					{
						...
						root: true,
						alignment: 'left',
						page: '/employee-management/companies',
					},
					{
						title: 'Jobs',
						root: true,
						alignment: 'left',
						page: '/employee-management/jobs',
					},
					{
						title: 'Billings',
						root: true,
						alignment: 'left',
						page: '/employee-management/billings',
					},
					{
						title: 'Assets',
						root: true,
					...
					},
					{
						...
						submenu: [
							...
							{
								title: 'Reports',
								page: '/employee-management/reports'
							},
							{
								title: 'Settings',
								page: '/employee-management/settings'
							}
						]
					},	
				]
			...
			header:{
				items:[
					...
					},
					{
						...
						root: true,
						alignment: 'left',
						page: '/employee-management/invoices',
					},
					{
						title: 'Time-off',
						root: true,
						alignment: 'left',
						page: '/employee-management/timeoffs',
					},
					{
						title: 'Employees',
						root: true,
						alignment: 'left',
						page: '/employee-management/companyEmployees',
					},
					{
						title: 'Applicants',
						root: true,
						alignment: 'left',
						page: '/employee-management/proposals',
					},
					{
						title: 'Hours',
						root: true,
						alignment: 'left',
						page: '/employee-management/companies/hours',
					},
				]
			}
		},
			...
			header:{
				items:[
					...
					},
					{
						...
						root: true,
						alignment: 'left',
						page: '/employee-management/jobs/list',
						translate: 'MENU.DASHBOARD',
					},
					{
						title: 'Payments',
						root: true,
						alignment: 'left',
						page: '/employee-management/payments',
						translate: 'MENU.DASHBOARD',
					},
					{
					...
					},
					{
						...
						root: true,
						alignment: 'left',
						page: '/employee-management/commissions',
					},
				]
			}
		},
