...
@Component({
	...
	selector: 'kt-meta-profile',
	templateUrl: './meta-profile.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class MetaUserProfileComponent implements OnInit, OnDestroy {
// Incoming data
		...
		this.profileMenus = [
			{
				'label':'Account',
				'slug':'profile',
				'link':'/employee-management/profile',
				'icon':'person'
			},
			{
				'label':'BankDetails',
				'slug':'bank',
				'link':'/employee-management/profile/bank',
				'icon':'account_balance'
			},
			{
				'label':'Assets',
				'slug':'assets',
				'link':'/employee-management/profile/assets',
				'icon':'personal_video'
			},
			{
				'label':'Hours',
				'slug':'hours',
				'link':'/employee-management/profile/hours',
				'icon':'access_time'
			},
		];
	}
