...
@Component({
	...
	selector: 'kt-invoice-company-read-dialog',
	templateUrl: './invoice-company-read.dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class InvoiceCompanyReadDialogComponent implements OnInit, OnDestroy {
	// Public properties
	 ...
	 *
	 * @param dialogRef: MatDialogRef<InvoiceCompanyReadDialogComponent>
	...
	constructor(
		...
		public dialogRef:MatDialogRef<InvoiceCompanyReadDialogComponent>,
	...
	getTitle(): string {
		let label = "Invoice ";
		if(this.invoice.status == "Proforma"){
			label = "Proforma ";
		}
	...
	updateStatus(status:string) {
		if(confirm("Are you sure this action?")){
			...
			this.invoiceService.updateStatus(invoice).pipe().subscribe();
