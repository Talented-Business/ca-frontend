...
@Component({
	selector: 'kt-invoice-company-list',
	templateUrl: './invoice-company-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class InvoiceCompanyListComponent implements OnInit, OnDestroy {
	// Table fields
	// Incoming data
	dataSource: InvoicesDataSource;
	displayedColumns = ['invoice', 'date', 'company','amount','status', 'actions'];
